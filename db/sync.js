...
module.exports = {
    ...
    getUser : async (id) => {
        ...
        // check modifiedDates of local / db notes in a forEach loop
        // if they're different, update the .text of the local note to the .text from the note with the more recent modifiedDate
        return user;
    },
    ...
    deleteAll : async (userID) => {
        // delete every note on the database to nuke it
    }
